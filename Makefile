...
SRC = main.c algorithms/algorithms.c pixelBuffer/pixelBuffer.c input-handling/handlers.c input-handling/handle-input.c utils/utils.c button/button.c input-handling/handle-ui.c
